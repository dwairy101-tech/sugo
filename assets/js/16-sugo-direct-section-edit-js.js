(function(){
  ...
  function contentTarget(pane){
    ...
    if(preferred){ preferred.classList.add('sugo-direct-edit-target'); return preferred; }
  ...
  function install(){
    ...
    // v6 performance: no full-body MutationObserver / interval.
    // showPane and direct click handlers inject the edit toolbar when needed.
  }

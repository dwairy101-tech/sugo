...
1. فك ضغط ملف `SUGO_GITHUB_READY_v4.0.0.zip`.
...
الإصدار 4 يجعل SOP Only هو الوضع الافتراضي، ويرفض التخمين عند غموض السؤال، ويفصل بين دليل الإجراء وبين قالب تذكرة يؤكد أن طلبًا تم تقديمه فعلاً.
